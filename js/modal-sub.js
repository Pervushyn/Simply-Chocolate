document.addEventListener('DOMContentLoaded', function() {
    ...
    const openModalButton = document.querySelector('.button-subscribe');
    const modal = document.querySelector('.backdrop-subscribe');
    ...
    document.querySelector('.modal-subscribe').addEventListener('click', function(event) {
