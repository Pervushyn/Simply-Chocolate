document.addEventListener('DOMContentLoaded', function() {
    ...
    const openModalButton = document.querySelector('.menu-icon');
    const modal = document.querySelector('.backdrop-menu');
    ...
    document.querySelector('.modal-menu').addEventListener('click', function(event) {
